...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $nama_api = "postPenilaianPredikatKinerjaBawahan";
    $request = $_POST;
    $status = "success";
    $error_message = "";

    $required_params = ['pegawai_id', 'informasi_id', 'bln', 'total_wpt', 'total_angka_kredit', 'total_nilai_rata_rata_kinerja', 'nilai_perilaku', 'nilai_hasil_kerja'];
    ...
    foreach ($required_params as $param) {
        if (empty($_POST[$param])) {
            ...
            exit(); // Hentikan eksekusi jika ada parameter yang kosong
        }
    }
